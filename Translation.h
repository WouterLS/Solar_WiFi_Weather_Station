...
******* Transaltion tables ****************************************/
  ...
  const char TEXT_ZAMBRETTI_B[]       = "Mooi weer";
  const char TEXT_ZAMBRETTI_C[]       = "Wordt mooi";
  const char TEXT_ZAMBRETTI_D[]       = "Mooi, minder stabiel";
  ...
  const char TEXT_ZAMBRETTI_K[]       = "Redelijk mooi, regen verwacht";
  ...
  const char TEXT_ZAMBRETTI_W[]       = "Regelmatig regen";
